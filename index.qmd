    ...
    min-book-typst:
      ...
      ensurePdfRegexMatches:
        - # matches array (first positional argument)
          ...
          - "see Warn[\\s\\S]*1\\.1 for\\s+the tea warning from Chapter"
          ...
          - "see Dinosaur 1\\.1 from Chapter\\s+1 and\\s+Dinosaur 2\\.1"
          - "See Dinosaur A\\.1 for the appendix dinosaur"
          - "see Dinosaur 1\\.1 from Chapter\\s+1"
          # Appendix B content
          ...
          - "Recall Equation \\(1\\.1\\) from Chapter 1\\s+and Equa[\\s\\S]*\\(1\\.2\\)"
          - "Recall Equation \\(1\\.1\\) from Chapter 1\\s+and Equa[\\s\\S]*\\(2\\.1\\)"
          ...
          - "Recall Theorem 1\\.1\\s+and\\s+Lemma 1\\.1 from Chapter 1"
          ...
          - "See Listing 1\\.1 and Listing 1\\.2 from\\s+Chapter 1"
          - "See Listing 1\\.1 from Chapter 1 and\\s+Listing 2\\.1 from\\s+Chapter 2"
---
